...
namespace rh.Controllers
{
    public class DepensesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,DateDepense,NomClient,VilleClient,MotifDepense,NombreKms,LocationVoiture,TaxiBus,AvionTrain,ParkingPeage,Restaurant,Hotel,Divers,TauxDevise,Commentaire,CommentaireRefus")] Depense depense)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,DateDepense,NomClient,VilleClient,MotifDepense,NombreKms,LocationVoiture,TaxiBus,AvionTrain,ParkingPeage,Restaurant,Hotel,Divers,TauxDevise,Commentaire,CommentaireRefus")] Depense depense)
        {
            if (id != depense.ID)
            {
                return NotFound();
